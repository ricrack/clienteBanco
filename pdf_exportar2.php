...
*/
    ...
    $pdf->SetFont('Arial','B',10);
    $pdf->MultiCell(0,5,utf8_decode(strtoupper("TRANSFERENCIA")),0,'C',false);
    $pdf->SetFont('Arial','',9);
    ...
    $pdf->MultiCell(0,5,utf8_decode("No. Cliente: $cuenta"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("No. Destinatario: $no_cuenta_destinatario"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("Cantidad transferida: $monto"),0,'C',false);
    ...
    # Codigo de barras #
    $pdf->Code128(5,$pdf->GetY(),"COD000001V0002",70,20);
    $pdf->SetXY(0,$pdf->GetY()+21);
    $pdf->SetFont('Arial','',14);
    $pdf->MultiCell(0,5,utf8_decode("COD000001V0002"),0,'C',false);
